 ...
 *
 * In the example below, the test of the private function drove out two if
 * statements that are simultaneously unreachable in production (e.g. dead code)
 * that nevertheless have 100% code coverage (e.g. no one will ever feel safe
 * deleting them).
 *
 ...
 * what the author intends to prevent others coming to depend on so that the
